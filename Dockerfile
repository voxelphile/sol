...
RUN rustup default nightly  && rustup target add --toolchain nightly aarch64-unknown-linux-musl && cargo +nightly build --release --bin sol --target aarch64-unknown-linux-musl
